      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        <div className="opacity-0 group-hover:opacity-100 flex items-center gap-0.5 ml-1 transition-opacity">
          <button
            ...
            className="p-1 text-slate-400 hover:text-[#6567F1] rounded transition-colors"
          >
            <Pencil size={13} />
          </button>
          <button
    ...
    <div className="flex-1 min-w-0">
      ...
      {adding ? (
        <div className="mt-2 space-y-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 text-sm py-1.5 bg-[#6567F1]/10 text-[#6567F1] rounded hover:bg-[#6567F1]/20 disabled:opacity-50 transition-colors"
            >
            ...
            <button
              ...
              className="px-3 text-sm text-slate-500 hover:text-slate-700 transition-colors"
            >
              Отмена
            </button>
          </div>
        ...
        <button
          ...
          className="mt-2 flex items-center gap-1 text-sm text-[#6567F1]/60 hover:text-[#6567F1] transition-colors"
        >
          <Plus size={14} />
          Добавить
        </button>
  ...
  return (
    <div className="flex-1 min-w-0">
      ...
      {adding ? (
        <div className="mt-2 space-y-2">
          ...
          <div className="flex gap-2">
            <button
              onClick={handleAdd}
              disabled={saving || !newName.trim() || !newAmount}
              className="flex-1 text-sm py-1.5 bg-emerald-50 text-emerald-600 rounded hover:bg-emerald-100 disabled:opacity-50 transition-colors"
            >
              {saving ? "Сохранение..." : "Добавить"}
            </button>
            <button
        ...
        <button
          onClick={() => setAdding(true)}
          className="mt-2 flex items-center gap-1 text-sm text-emerald-600/60 hover:text-emerald-600 transition-colors"
        >
          <Plus size={14} />
          Добавить
        </button>
...
export default function ManagementPage() {
  ...
  async function captureSnapshot() {
    ...
    try {
      ...
      if (!res.ok) throw new Error("Не удалось зафиксировать снимок");
  ...
  const snapshotChartData = snapshots.map((s) => ({
    name: `${MONTHS_RU[s.month - 1]} ${String(s.year).slice(2)}`,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        >
          <TrendingUp size={15} />
          {capturing ? "Фиксируем..." : "Зафиксировать снимок"}
        </button>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5">
          ...
          {snapshotChartData.length === 0 ? (
            <div className="h-48 flex items-center justify-center text-slate-400 text-sm">
              Нет данных. Нажмите «Зафиксировать снимок».
            </div>
          ) : (
            <ResponsiveContainer width="100%" height={200}>
              <BarChart data={snapshotChartData} margin={{ top: 4, right: 4, left: 0, bottom: 0 }}>
