...
-- CreateIndex
CREATE UNIQUE INDEX "permissions_entity_action_key" ON "permissions"("entity", "action");
...
-- CreateIndex
CREATE UNIQUE INDEX "section_members_section_id_user_id_key" ON "section_members"("section_id", "user_id");
...
-- AddForeignKey
ALTER TABLE "section_members" ADD CONSTRAINT "section_members_section_id_fkey" FOREIGN KEY ("section_id") REFERENCES "sections"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "section_members" ADD CONSTRAINT "section_members_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organizations" ADD CONSTRAINT "organizations_section_id_fkey" FOREIGN KEY ("section_id") REFERENCES "sections"("id") ON DELETE SET NULL ON UPDATE CASCADE;
