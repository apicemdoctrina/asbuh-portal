...
- Права задаются на уровне: _сущность_ (организация/документ/контакт/материал) × _действие_ (view/create/edit/delete).
...
_(Если решите, что кастомные поля появятся только в Этап 2 — можно упростить и оставить только JSONB без UI-конфигуратора, но лучше заложить хотя бы структуру.)_
...
_(2FA: запланировано в ROADMAP, но архитектурно не блокируем.)_
